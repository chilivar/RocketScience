...
SECRET_KEY = 'django-insecure-q^3z#tl9^*f0py!8si&zg_&-wys1q&4_#djv7p6e*+t2e(g!-#'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'b0xkq1C}T~*uAW',             # Пароль пользователя
        'HOST': '194.87.84.151',                   # IP-адрес или домен сервера, например, '127.0.0.1' или 'db.example.com'
